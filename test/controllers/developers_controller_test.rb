...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { email: @developer.email, full_name: @developer.full_name, mobile: @developer.mobile } }, as: :json
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { email: @developer.email, full_name: @developer.full_name, mobile: @developer.mobile } }, as: :json
    assert_response 200
  end
